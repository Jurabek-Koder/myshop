/** Operator suhbat namunasi: admin interfeysidagi Vapi transcript qatorlari. */

export const SEED_CONVERSATION_VAPI_ID = 'myshop-seed-conversation';

export const SEED_DIALOGUE_LINES = [
  {
