...
router.delete('/work-roles/:id/permanent', (req, res) => {
  ...
  if (workRoleHasArchiveHistory(id)) {
    return res.status(400).json({
      error:
        'Bu rol moliya yoki zakaz tarixi bilan bog‘langan — butunlay o‘chirib bo‘lmaydi. Faqat superuser arxivida saqlanadi.',
    });
  }
...
router.post('/ad-slides', (req, res) => {
  ...
  const image_url = sanitizeMediaUrl(req.body?.image_url, 800);
  const image_url_mobile = sanitizeMediaUrl(req.body?.image_url_mobile, 800);
...
router.patch('/ad-slides/:id', (req, res) => {
  ...
  if (req.body?.image_url !== undefined) {
    image_url = sanitizeMediaUrl(req.body.image_url, 800);
  }
  let image_url_mobile = existing.image_url_mobile;
  if (req.body?.image_url_mobile !== undefined) {
    image_url_mobile = sanitizeMediaUrl(req.body.image_url_mobile, 800);
  }
