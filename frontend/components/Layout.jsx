...
export default function Layout() {
  ...
  const isPackerUi = Boolean(user && String(user?.role || '').toLowerCase() === 'packer');
  ...
  return (
    <NavCategoryMenuProvider setMenuOpen={setMenuOpen} menuOpen={menuOpen}>
          ...
          <div className="main-bar">
            <div className="container header-inner">
              ...
              <div className="header-mobile-actions">
                ...
                <NavCategoryMobileTrigger />
                <ThemeToggle className="site-header-theme-toggle" />
              ...
              {user ? (
                <>
                  ...
                  {isTargetPrincipal(user) && (
                    <Link to="/target" className={isActive('/target') ? 'active' : ''} onClick={() => setMenuOpen(false)}>Target paneli</Link>
                  )}
                  {isSellerPrincipal(user) && (
