...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    resolve: {
      /** Ikki nusxa React → forwardRef undefined (prod vendor chunk). */
    ...
    build: {
      ...
      /** manualChunks olib tashlandi: vendor ↔ react-vendor aylana bog‘liqlik prod da oq «MyShop» ekraniga olib kelardi. */
      rollupOptions: {},
