...
export default function StaffSidePanel({
  ...
  brandTitle = 'MyShop',
  brandSubtitle,
  /** Brend blokining o‘ng tarafida ko‘rsatiladigan qo‘shimcha element (masalan, profil ID) */
  headExtra,
  userName,
  userRole,
  navItems,
      ...
      >
        <div className="picker-side-panel-inner">
          <div className="staff-side-panel-head">
            <div className="staff-side-panel-head-row">
              <div className="staff-side-panel-brand">
                <span className="staff-side-panel-logo-icon" aria-hidden>
                  {brandIcon}
                </span>
                <span className="staff-side-panel-logo-title">{brandTitle}</span>
              </div>
              {headExtra ? <div className="staff-side-panel-head-extra">{headExtra}</div> : null}
            </div>
            {brandSubtitle ? <div className="staff-side-panel-logo-subtitle">{brandSubtitle}</div> : null}
          </div>
          {(userName || showRole) && (
