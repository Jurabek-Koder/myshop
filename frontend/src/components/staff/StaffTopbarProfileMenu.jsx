...
/**
 * Barcha rollar: profil bosilganda markaziy «shisha» menyu (portal).
 */
export default function StaffTopbarProfileMenu({
    ...
    open && typeof document !== 'undefined'
      ? createPortal(
          <>
            ...
            />
            <div
              className="staff-profile-popover-center-shell"
              role="presentation"
              onClick={() => onOpenChange(false)}
            >
              <div
                className="staff-profile-popover-menu"
                role="menu"
  ...
  return (
    <div className="staff-profile-popover-wrap" ref={wrapRef}>
      <button
        type="button"
