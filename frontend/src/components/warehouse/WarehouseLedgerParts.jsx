...
export function WarehouseActionsColumn({
  ...
  // Bosh sahifa va Kirim/Chiqim sahifalarida «Sotuvdan olish» tugmasi ko‘rsatilmaydi —
  // bu amal Brak va Sotuvdan olinganlar sahifalarida qoladi.
  const showSaleToggle =
    actionsContext !== 'home' && actionsContext !== 'kirim_page' && actionsContext !== 'chiqim_page';
...
export function warehouseKirimChiqimSheetMainRowClass(view, p) {
  if (view === 'kirim' || view === 'chiqim' || view === 'delisted' || view === 'deleted') {
    ...
    if ((view === 'kirim' || view === 'chiqim' || view === 'delisted') && p.warehouse_approved_at) {
