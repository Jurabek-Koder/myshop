 ...
 */
import { UZ_VILOYAT_DISTRICTS } from './uzViloyatTumanlari.js';
...
/** Viloyat bo‘yicha tuman / shahar ro‘yxati (profil sozlamalari va boshqalar) */
export function getDistrictsForViloyat(regionId) {
  const id = String(regionId || '').trim();
  if (!id) return [];
  if (id === 'toshkent_sh') return TOSHKENT_SH_TUMANS;
  return UZ_VILOYAT_DISTRICTS[id] || [];
}
