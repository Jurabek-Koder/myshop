...
import { isSellerPrincipal, isTargetPrincipal } from './utils/sellerPrincipal.js';
...
const TargetDashboard = lazy(() => import('./pages/target/TargetDashboard.jsx'));
...
const AccountingShell = lazy(() => import('./pages/accounting-panel/AccountingShell.jsx'));
const AcDashboard = lazy(() => import('./pages/accounting-panel/pages/DashboardPage.jsx'));
const AcPayroll = lazy(() => import('./pages/accounting-panel/pages/PayrollPage.jsx'));
const AcFinance = lazy(() => import('./pages/accounting-panel/pages/FinancePage.jsx'));
const AcAnalytics = lazy(() => import('./pages/accounting-panel/pages/AnalyticsPage.jsx'));
const AcProductsReport = lazy(() => import('./pages/accounting-panel/pages/ProductsReportPage.jsx'));
const AcKuryerlar = lazy(() => import('./pages/accounting-panel/pages/KuryerlarPage.jsx'));
const AcRoleFinance = lazy(() => import('./pages/accounting-panel/pages/RoleFinancePage.jsx'));
const AcArchive = lazy(() => import('./pages/accounting-panel/pages/ArchivePage.jsx'));
...
function TargetRoute({ children }) {
  ...
  if (!isTarget(user) || authStatus === 'forbidden') {
    return (
      <ForbiddenGate
        message={
          String(user?.role || '').toLowerCase() === 'seller'
            ? "Siz seller sifatida kirgansiz. Target panel uchun target akkaunt bilan qayta kiring yoki «Chiqish» qilib to‘g‘ri loginni tanlang."
            : 'Target panel faqat target roli uchun.'
        }
      />
    );
  }
...
function WarehouseAdminRoute({ children }) {
  ...
  if (!isWarehouseAdmin(user) || authStatus === 'forbidden') {
    return <ForbiddenGate message="Ombor admin paneli faqat ombor admin roli uchun." />;
  }
        ...
        <Routes>
          ...
          <Route
            ...
            element={(
              <SuspensePanel>
                <AdminRoute>
                  <Navigate to="/admin?view=activity_log" replace />
                </AdminRoute>
              </SuspensePanel>
            )}
          />
          ...
          <Route
            ...
            element={(
              <SuspensePanel>
                <TargetRoute><TargetDashboard /></TargetRoute>
              </SuspensePanel>
            )}
          />
          <Route
          ...
          <Route
            ...
            element={(
              <SuspensePanel>
                <WarehouseAdminRoute><WarehouseAdminDashboard /></WarehouseAdminRoute>
              </SuspensePanel>
            )}
          />
          <Route
          ...
          >
            ...
            <Route path="ish-haqi" element={<AcPayroll />} />
            <Route path="moliya" element={<AcFinance />} />
            <Route path="tahlil" element={<AcAnalytics />} />
            <Route path="mahsulotlar-hisoboti" element={<AcProductsReport />} />
            <Route path="kuryerlar" element={<AcKuryerlar />} />
            <Route path="staff/:role" element={<AcRoleFinance />} />
            <Route path="oylik-maosh-arxivi" element={<AcArchive />} />
            <Route path="boshqaruv" element={<Navigate to="/accounting" replace />} />
