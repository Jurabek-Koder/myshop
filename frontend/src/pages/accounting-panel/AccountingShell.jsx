...
const NAV = [
  ...
  { to: '/accounting/mahsulotlar-hisoboti', label: uz.nav.productsReport, icon: 'fa-box' },
  { to: '/accounting/staff/courier', label: 'Kuryerlar', icon: 'fa-motorcycle' },
  { to: '/accounting/staff/operator', label: 'Operatorlar', icon: 'fa-headset' },
  { to: '/accounting/staff/packer', label: 'Qadoqlovchilar', icon: 'fa-box' },
  { to: '/accounting/staff/picker', label: "Yig'uvchilar", icon: 'fa-hand-holding' },
  { to: '/accounting/staff/expeditor', label: 'Ekspeditorlar', icon: 'fa-truck' },
  { to: '/accounting/staff/seller', label: 'Sotuvchilar', icon: 'fa-store' },
  { to: '/accounting/staff/warehouse_admin', label: 'Ombor Adminlari', icon: 'fa-warehouse' },
  { to: '/accounting/oylik-maosh-arxivi', label: uz.nav.payrollArchive, icon: 'fa-archive' },
];
