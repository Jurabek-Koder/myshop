...
function resolveReturnTarget(rawFrom, user) {
  ...
  try {
    ...
    if (pathname.startsWith('/warehouse-admin')) {
      return isWarehouseAdmin(user) ? fullTarget : '';
    }
    if (pathname.startsWith('/accounting')) {
      return isAccounting(user) ? fullTarget : '';
    }
    ...
    <div className="login-page login-page--auth">
      <aside className="login-brand-panel" aria-hidden="true">
        ...
        <div className="login-brand-inner">
          ...
          <h2 className="login-brand-headline">Savdo va buyurtmalarni zamonaviy boshqaring</h2>
          <p className="login-brand-lead">Admin, sotuvchi va xodimlar uchun yagona panel — istalgan qurilmadan.</p>
          <ul className="login-brand-list">
            <li>Buyurtmalar va mahsulotlar bir joyda</li>
            <li>Rol bo‘yicha xavfsiz kirish</li>
            <li>Telefon, planshet va kompyuterga mos</li>
          </ul>
        </div>
      </aside>
      ...
      <div className="login-content">
        ...
        <div className="login-card-stage">
          <div className="login-card card">
            ...
            <p className="login-subtitle">Hisobingizga kiring — do‘kon yoki xodim paneliga yo‘naltiramiz.</p>
            <div className="login-deco" />
            <form className="login-form" onSubmit={handleSubmit}>
              <div className="form-group">
                <label htmlFor="login-email">Email yoki login</label>
                <input
                  id="login-email"
                  type="text"
                  value={email}
