...
import ChatSectionTabs from '../components/chatGroups/ChatSectionTabs.jsx';
import ChatDmOversightPanel from '../components/chatGroups/ChatDmOversightPanel.jsx';
...
export default function AdminDashboard() {
  ...
  const [chatSubTab, setChatSubTab] = useState('lichka');
  const [externalDmPeer, setExternalDmPeer] = useState(null);
    ...
    <div className={`admin-dashboard ${darkMode ? 'admin-dark' : ''}`}>
      ...
      >
        ...
        >
          ...
          {activeView === 'staff_chat' ? (
            <div className="chat-groups-inline-wrap">
              <ChatSectionTabs
                active={chatSubTab}
              ...
              {chatSubTab === 'guruh' ? (
                <ChatGroupsScreen
                  onMessageUser={(peer) => {
                    setExternalDmPeer(peer);
                    setChatSubTab('lichka');
                  }}
                />
              ) : chatSubTab === 'oversight' ? (
                <ChatDmOversightPanel />
              ) : (
                <AdminStaffChat onExitChat={() => setActiveViewWithUrl('dashboard')} externalPeer={externalDmPeer} />
              )}
            </div>
          ) : loading ? (
