...
export default function AdminDashboard() {
  ...
  const selectedCustomerOldPasswords = useMemo(() => {
    // password_history_preview endi faqat note larni ko'rsatadi (parollar saqlanmaydi)
    ...
    return raw
      ...
      .map((entry) => {
        ...
        const note = txt.slice(sep + 2);
        return { id: Number.isInteger(id) && id > 0 ? id : null, value: note };
      })
      .filter((x) => x && x.value);
  }, [selectedCustomer]);
                              ...
                              <td>
                                <div className="admin-customers-pass-inline">
                                  <span className="admin-customers-pass-chip">
                                    {row.has_password_hash ? "Parol o’rnatilgan" : "O’rnatilmagan"}
                                  </span>
                                </div>
                              </td>
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <div className="admin-customers-pass-inline">
                                      <span className="admin-customers-pass-chip">
                                        {selectedCustomer.has_password_hash ? "Parol o’rnatilgan" : "O’rnatilmagan"}
                                      </span>
                                    </div>
                                  <div className="admin-customers-password-cell">
                                    ...
                                    {selectedCustomerOldPasswords.length > 0 && (
                                      <div className="admin-customers-old-passwords">
                                        ...
                                        >
                                          Parol o’zgartirishlar tarixi ({selectedCustomerOldPasswords.length})
                                          <i
                                            className={`fas ${
                                          ...
                                          <div className="admin-old-passwords-overlay" onClick={() =>
                                            ...
                                            >
                                              <div className="admin-old-passwords-panel-head">
                                                <strong>Parol o’zgartirishlar tarixi</strong>
                                                <button
                                                  type="button"
