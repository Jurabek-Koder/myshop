...
export default function PickerDashboard() {
  ...
  const PICKER_TAB_KEYS = useMemo(
    () =>
      new Set([
        ...
        ...['profile', 'settings', 'chat', 'lichka', 'guruh'],
      ]),
    [bottomTabs]
  );
  ...
  const sideNavItems = useMemo(
    () => [
      ...
      { id: 'guruh', label: 'Sklad guruhi', icon: '👥' },
  ...
  const telegramMainLayout = tab === 'chat' || tab === 'lichka' || tab === 'guruh';
  ...
  return (
    <div className="picker-app picker-mobile">
      ...
      >
        ...
        {tab === 'guruh' && <ChatGroupsScreen onExit={() => setTab('home')} />}
