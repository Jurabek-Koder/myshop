...
export default function ExpeditorDashboard() {
  ...
  /** Soat o‘rnida: viloyat + ro‘yxat ochiq → «Listni yopish» */
  const showCloseHandoffListBtn = Boolean(isHome && hasViloyatFilter && !mainHandoffListClosed);
          ...
          <div className="expeditor-topbar-trailing">
            <div className="packer-staff-topbar-actions expeditor-staff-topbar-actions">
              ...
              <StaffTopbarProfileMenu
                ...
                onHome={() => navigate('/')}
                onProfile={() => navigate('/expeditor/profile')}
                onSettings={() => navigate('/expeditor/profile')}
                onLogout={() => {
                  logout();
                  navigate('/login');
                }}
