          ...
          <main className={`target-content${isMyChatView ? ' target-content--mychat' : ''}`}>
            {activeView === 'cabinet' ? (
              ...
              <div className="chat-groups-inline-wrap">
                <ChatSectionTabs active={chatSubTab} onChange={setChatSubTab} groupLabel="Targetologlar guruhi" />
                {chatSubTab === 'guruh' ? (
                  <ChatGroupsScreen
                    onMessageUser={(peer) => {
                  ...
                  <TargetMyChatView onOpenSidePanel={() => setSidebarOpen(true)} externalPeer={externalDmPeer} />
                )}
              </div>
            ) : activeView === 'profile' ? (
