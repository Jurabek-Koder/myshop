          ...
          <main className="picker-main warehouse-admin-main">
            ...
            >
              ...
              {(view === 'courier' ||
                ...
                view === 'expeditor' ||
                view === 'order_receiver') && (
                <div className="warehouse-admin-placeholder-page">
                  <div className="warehouse-admin-placeholder-icon" aria-hidden>
                    🛠️
                  </div>
                  <p className="warehouse-admin-placeholder-title">{nonChatTitle} boʻlimi tez orada</p>
                  <p className="warehouse-admin-placeholder-text">
                    Bu sahifa hozircha ishlanmoqda. Tez orada shu yerda {nonChatTitle.toLowerCase()}ga oid
                    maʼlumotlar chiqadi.
                  </p>
                </div>
              )}
