            ...
            >
              ...
              {STAFF_DIRECTORY_VIEWS.has(view) && (
                <div className="warehouse-admin-staff-directory">
                  ...
                  <div className="warehouse-admin-staff-directory-table" role="table" aria-label={nonChatTitle}>
                    <div className="warehouse-admin-staff-directory-row warehouse-admin-staff-directory-row--head" role="row">
                      <span role="columnheader">Ism</span>
                    ...
                    {!staffDirectoryLoading &&
                      staffDirectoryRows.map((s) => (
                        <div key={s.id} className="warehouse-admin-staff-directory-row" role="row">
                          <span role="cell" className="warehouse-admin-staff-directory-cell-name">
                            {s.full_name}
                          </span>
                          <span role="cell" className="warehouse-admin-staff-directory-cell-muted">
                            {s.login || '—'}
                          </span>
                          <span role="cell" className="warehouse-admin-staff-directory-cell-muted">
                            {s.phone || '—'}
                          ...
                          <span role="cell">
                            <span
                              className={`warehouse-admin-staff-online-badge${
                                s.online ? ' warehouse-admin-staff-online-badge--online' : ''
                              }`}
                            >
                              <i aria-hidden />
                              {s.online ? 'Onlayn' : 'Oflayn'}
                            </span>
                          </span>
                        </div>
                      ))}
