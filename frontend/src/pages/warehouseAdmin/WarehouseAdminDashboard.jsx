              ...
              <div className="warehouse-admin-daily-modal-body">
                ...
                {!homeLeftModal.loading &&
                  homeLeftModal.products.map((p, idx) => (
                    <div key={`${p.order_id}-${p.product_id}-${idx}`} className="warehouse-admin-daily-modal-receipt-row">
                      <div className="warehouse-admin-daily-modal-receipt-main">
                        <span className="warehouse-admin-daily-modal-receipt-id">{p.name_uz}</span>
                        <span className="warehouse-admin-daily-modal-receipt-courier">
                          #{p.order_id} · {p.quantity} dona
                        </span>
                      </div>
                      <span className="warehouse-admin-daily-modal-receipt-sum">
                        {formatSum(p.price * p.quantity)}
                      </span>
                    </div>
                  ))}
              </div>
