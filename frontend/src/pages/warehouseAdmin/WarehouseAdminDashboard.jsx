                          ...
                          <div key={s.id} className="warehouse-admin-staff-directory-row" role="row">
                            {STAFF_DIRECTORY_COLUMNS[view].map((col) => {
                              ...
                              if (col.key === 'full_name') {
                                return (
                                  <span role="cell" key={col.key} className="warehouse-admin-staff-directory-cell-name">
                                    <i
                              ...
                              if (
                                col.key === 'courier_balance' ||
                                col.key === 'deposit' ||
                                col.key === 'balance'
                              ) {
                                return (
                                  <span role="cell" key={col.key} className="warehouse-admin-staff-directory-cell-muted">
                                    {formatSum(val)}
                                  </span>
                                );
                              }
                              if (col.key === 'commission_percent' || col.key === 'rating_percent') {
                                return (
                                  <span role="cell" key={col.key} className="warehouse-admin-staff-directory-cell-muted">
                                    {Number(val) || 0}%
                                  </span>
