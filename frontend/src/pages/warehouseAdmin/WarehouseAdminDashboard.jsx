  ...
  return (
    <div className="picker-app picker-mobile warehouse-admin-shell">
      <div className={`picker-phone-frame${isChatView ? ' picker-phone-frame--no-topbar' : ''}`}>
        ...
        {isChatView ? (
          <main className="picker-main picker-main--telegram warehouse-admin-main chat-groups-inline-wrap">
            <ChatSectionTabs active={chatSubTab} onChange={setChatSubTab} groupLabel="Guruhlar" />
            {chatSubTab === 'guruh' ? (
              <ChatGroupsScreen
                onMessageUser={(peer) => {
