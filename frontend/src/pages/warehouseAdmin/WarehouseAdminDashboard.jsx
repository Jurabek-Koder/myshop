                ...
                <section className="picker-subpage">
                  ...
                  <div className="picker-profile-card">
                    {waProfileLoading ? (
                      ...
                      <form className="picker-profile-form" onSubmit={handleWaProfileSave}>
                        {waProfileError ? (
                        ...
                        <label className="picker-profile-field">
                          ...
                          <input type="email" className="picker-profile-input" value={waProfileForm.email} readOnly />
                        </label>
                        <label className="picker-profile-field">
                          <span className="picker-profile-label">{pickerUiT.profileLogin}</span>
                          <input type="text" className="picker-profile-input" value={waProfileForm.login} readOnly />
                        </label>
                        <label className="picker-profile-field">
