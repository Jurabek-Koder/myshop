...
export default function SellerDashboard() {
  ...
  useLayoutEffect(() => {
    ...
    if (typeof window === 'undefined' || isDesktop || activeView === 'chat') {
        ...
        >
          ...
          {activeView === 'chat' && (
            <div className="chat-groups-inline-wrap">
              <ChatSectionTabs active={chatSubTab} onChange={setChatSubTab} groupLabel="Sellerlar guruhi" />
              {chatSubTab === 'guruh' ? (
                <ChatGroupsScreen
                  onMessageUser={(peer) => {
