...
import './index.css';
/** Buxgalteriya paneli dizayni — barcha qoidalar [data-apanel] ostida, boshqa sahifalarga ta’sir qilmaydi */
import './pages/accounting-panel/AccountingDesign.css';
...
/** KPI kartalar tun/kun — barcha CSS dan keyin */
import './pages/accounting-panel/KpiCardTheme.css';
/** Ombor admin yon paneli — staffSidePanelRef dan keyin */
import './styles/warehouseAdminSidePanel.css';
/** Buxgalteriya yon paneli */
import './styles/accountingSidePanel.css';
/** Barcha rollar yon menyusi — shaffof panel + blur overlay */
import './styles/staffSidePanelGlass.css';
import './styles/staffSidePanelUnifiedGlass.css';
/** Faqat native (Android/iOS) ilovada ishlaydi; brauzerda hech narsaga tegmaydi. */
import { initCapacitorBootstrap } from './lib/capacitorBootstrap.js';
void initCapacitorBootstrap();
...
if (typeof window !== 'undefined' && typeof window.__myshopClearBootTimeout === 'function') {
  window.__myshopClearBootTimeout();
}
...
document.getElementById('myshop-boot')?.remove();
