...
import { applySavedTargetAccentColors } from '../utils/targetUiPrefs.js';
...
function applyTheme(mode) {
  ...
  try {
    ...
    if (meta) meta.setAttribute('content', mode === 'dark' ? '#0f172a' : '#2563eb');
  } catch {}
  applySavedTargetAccentColors(mode);
}
