...
export function AuthProvider({ children }) {
    ...
    refreshInFlightRef.current = (async () => {
      try {
        ...
        if (res.ok) {
          ...
          const alsoLocal = typeof localStorage !== 'undefined' && !!localStorage.getItem('refreshToken');
  ...
  const updateProfile = useCallback(
    async (body) => {
      ...
      if (data?.user) {
        setUser(data.user);
        const pl = typeof localStorage !== 'undefined' && !!localStorage.getItem('refreshToken');
