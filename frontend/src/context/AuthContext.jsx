...
export function AuthProvider({ children }) {
  ...
  const login = async (emailOrLogin, password) => {
    ...
    if (!access) {
      throw new Error(
        "Server token qaytarmadi. Qayta urinib ko'ring. Renderda: Static site Environment da " +
          "VITE_API_BASE_URL faqat API manzili bo'lsin (https://....onrender.com), oxiriga /api QO'YMAYDI — kod o'zi /api qo'shadi. " +
          "F12 → Network → login → Response: JSON da access/refresh bormi, tekshiring.",
      );
    }
